                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <?php
                            $fail_message = Session::get('admin_name');
                            if ($fail_message) {
                                echo $fail_message;
                            }
                            ?>
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/list-category-products') }}">Liệt kê danh mục sản phẩm</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/list-products') }}">Liệt kê sản phẩm</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-menu">
